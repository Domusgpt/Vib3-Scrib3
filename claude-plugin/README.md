...
> **Heads up:** Add Firebase credentials in `server/.env` to mirror these memories and signups into Firestore for downstream automations. Without Firebase configured, the plugin continues using the built-in lowdb store.
