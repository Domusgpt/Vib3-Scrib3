...
const ConsoleScaffold: React.FC<ConsoleScaffoldProps> = ({
    ...
    const guardedProfileSelect = React.useMemo(
        () => guardWithAuth(selectProfile),
        [guardWithAuth, selectProfile],
    );

    const guardedStartTrial = React.useMemo(
        () => guardWithAuth(startTrial),
        [guardWithAuth, startTrial],
    );

    const guardedUpgradePlan = React.useMemo(
        () => guardWithAuth(upgradePlan),
        [guardWithAuth, upgradePlan],
    );

    const guardedOpenPortal = React.useMemo(
        () => guardWithAuth(openPortal),
        [guardWithAuth, openPortal],
    );

    const guardedSwitchOrganization = React.useMemo(
