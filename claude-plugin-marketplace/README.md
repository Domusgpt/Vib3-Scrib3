...
3. Install the plugin:
   ...
   ```
4. Restart Claude Code to register the new commands, then run `/context-harvest`, `/style-sync`, and `/memory-primer` to prime Claude's memory before `/release-pulse`.
