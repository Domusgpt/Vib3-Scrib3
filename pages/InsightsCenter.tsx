...
const InsightsCenter: React.FC = () => {
    ...
    }, [authState.isAuthenticated, bootstrapError, isBootstrapping, loadAll, organizationId]);
    ...
    return (
        ...
        loadingEyebrow="Initializing"
        loadingMessage="Loading telemetry and workspace analytics…"
        loadingHint="Aggregating pulse, trend, and incident data for your active workspace."
        ...
        errorHint="We couldn't reach your workspace telemetry services. Retry once you're back online."
