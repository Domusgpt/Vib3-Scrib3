...
const InsightsCenter: React.FC = () => {
    ...
    const handleDisconnect = useGuardedHandler(guardWithAuth, disconnectIntegration);
    ...
    const handleProfileSelect = useGuardedHandler(guardWithAuth, selectProfileForInsights);
