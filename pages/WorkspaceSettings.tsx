...
const WORKSPACE_AUTH_PROMPT = 'Sign in to manage workspace settings.';
...
const WorkspaceSettings: React.FC = () => {
    ...
    const handleRequireAuth = useCallback(() => {
        ...
        setNotification(current => {
            if (current?.type === 'info' && current.message === WORKSPACE_AUTH_PROMPT) {
                return current;
            }
            return { type: 'info', message: WORKSPACE_AUTH_PROMPT };
        });
