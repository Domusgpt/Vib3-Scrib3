...
const WorkspaceSettings: React.FC = () => {
    ...
    const handleSwitchOrganization = useGuardedHandler(guardWithAuth, switchOrganizationAction);
    ...
    const handleInvite = useGuardedHandler(guardWithAuth, inviteMember);
    ...
    const handleCreateApiKey = useGuardedHandler(guardWithAuth, createApiKey);
    ...
    const handleCreateWebhook = useGuardedHandler(guardWithAuth, createWebhook);
    ...
    const handleSaveAuthPolicy = useGuardedHandler(guardWithAuth, saveAuthPolicy);
    ...
    const handleCreateWorkspace = useGuardedHandler(guardWithAuth, createWorkspace);
    ...
    const handleRevokeInvitation = useGuardedHandler(guardWithAuth, revokeInvitation);
    ...
    const handleRevokeApiKey = useGuardedHandler(guardWithAuth, revokeApiKey);
    ...
    const handleExportAuditLog = useGuardedHandler(guardWithAuth, exportAuditLog);
    ...
    const handleDeleteWebhook = useGuardedHandler(guardWithAuth, deleteWebhook);
    ...
    const handleTestWebhook = useGuardedHandler(guardWithAuth, testWebhook);
    ...
    const handleChangeMemberRole = useGuardedHandler(guardWithAuth, changeMemberRole);
    ...
    const handleRemoveMember = useGuardedHandler(guardWithAuth, removeMember);
    ...
    const handleStartTrial = useGuardedHandler(guardWithAuth, startTrialForWorkspace);
    ...
    const handleUpgrade = useGuardedHandler(guardWithAuth, upgradeWorkspace);
    ...
    const handleOpenPortal = useGuardedHandler(guardWithAuth, openBillingPortal);
