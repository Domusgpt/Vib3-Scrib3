...
const AUTH_PROMPT_MESSAGE = 'Sign in to continue with this action.';
...
const HomePage: React.FC = () => {
    ...
    const handleRequireAuth = useCallback(() => {
        ...
        setMessages(prev => {
            ...
            if (lastMessage?.author === MessageAuthor.SYSTEM && lastMessage.text === AUTH_PROMPT_MESSAGE) {
                return prev;
            }
            return [
                ...prev,
                {
                    ...
                    text: AUTH_PROMPT_MESSAGE,
                },
            ];
        });
    }, [setMessages, setProfileModalOpen]);
