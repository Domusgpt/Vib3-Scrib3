...
const HomePage: React.FC = () => {
    ...
    const handleOpenProfileModal = useGuardedHandler(guardWithAuth, openProfileModal);
    ...
    const handleSendMessage = useGuardedHandler(guardWithAuth, sendMessage);
    ...
    const handleProfileSelect = useGuardedHandler(guardWithAuth, selectProfileWithAnnouncement);
    ...
    const handleCreateProfile = useGuardedHandler(guardWithAuth, createProfile);
    ...
    const handleEditMessage = useGuardedHandler(guardWithAuth, editMessage);
    ...
    const handleDisconnectIntegration = useGuardedHandler(guardWithAuth, disconnectIntegration);
    ...
    const handleOrganizationChange = useGuardedHandler(guardWithAuth, switchOrganizationWithFeedback);

    const navigateToWorkspace = useCallback(() => {
        navigate('/workspace');
    }, [navigate]);

    const handleOpenWorkspaceSettings = useGuardedHandler(guardWithAuth, navigateToWorkspace);
