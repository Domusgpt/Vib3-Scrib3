...
const HomePage: React.FC = () => {
    ...
    const handleProfileSelect = useCallback(
        ...
        [ensureAuthenticated, profiles, selectProfile],
    );

    const handleCreateProfile = useCallback(async (name: string, source: ProfileSource) => {
        if (!ensureAuthenticated({ openModal: true })) {
            return;
        }
    ...
    }, [ensureAuthenticated, handleSendMessage]);
    ...
    const handleDisconnectIntegration = useCallback(
        ...
        [ensureAuthenticated, refreshAuthState],
    );
    ...
    const handleOrganizationChange = useCallback(
        ...
        [ensureAuthenticated, switchOrganization],
    );
