...
const IntegrationsHub: React.FC = () => {
    ...
    const disconnectIntegration = useCallback(
        ...
        [ensureAuthenticated, integrationSummaries, loadOverview, refreshAuthState],
    );
    ...
    const handleSync = useCallback(
        ...
        [ensureAuthenticated, loadOverview],
    );
    ...
    const handleOrganizationChange = useCallback(
        ...
        [ensureAuthenticated, loadOverview, switchOrganization],
    );
