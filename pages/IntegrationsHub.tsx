...
const IntegrationsHub: React.FC = () => {
    ...
    const disconnectIntegration = useGuardedHandler(guardWithAuth, disconnectIntegrationAction);
    ...
    const handleSync = useGuardedHandler(guardWithAuth, syncIntegration);
    ...
    const handleProfileSelect = useGuardedHandler(guardWithAuth, selectProfileForHub);
    ...
    const handleOrganizationChange = useGuardedHandler(guardWithAuth, changeOrganization);
    ...
    const handleSeedSandbox = useGuardedHandler(guardWithAuth, seedSandbox);
