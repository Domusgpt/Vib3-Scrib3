...
const IntegrationsHub: React.FC = () => {
    ...
    const disconnectIntegration = useCallback(
        guardWithAuth(async (integration: IntegrationSummary | IntegrationName) => {
            const summary =
        ...
        [guardWithAuth, integrationSummaries, loadOverview, refreshAuthState],
    );

    const handleSync = useCallback(
        guardWithAuth(async (integration: IntegrationSummary) => {
        ...
        [guardWithAuth, loadOverview],
    );

    const handleProfileSelect = useCallback(
        guardWithAuth(async (id: string) => {
    ...
    const handleOrganizationChange = useCallback(
        guardWithAuth(async (organizationId: string) => {
            try {
        ...
        [guardWithAuth, loadOverview, switchOrganization],
    );

    const handleSeedSandbox = useCallback(
        guardWithAuth(async () => {
