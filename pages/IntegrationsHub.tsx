...
const IntegrationsHub: React.FC = () => {
    ...
    }, [bootstrapError, isBootstrapping, loadOverview]);
    ...
    return (
        ...
        loadingEyebrow="Synchronizing"
        loadingMessage="Syncing integration overview…"
        loadingHint="Pulling workspace connections, billing, and usage snapshots."
        ...
        errorHint="We couldn't connect to your workspace. Retry to fetch the latest integration state."
