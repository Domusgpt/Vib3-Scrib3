...
- Package shared launch workflows in the bundled Claude Code plugin (`docs/CLAUDE_CODE_PLUGIN.md`), using `/context-harvest` and `/style-sync` to keep Claude's memory aligned with Vib3 Scribe profiles as release rituals evolve.
