...
- Package shared launch workflows in the bundled Claude Code plugin (`docs/CLAUDE_CODE_PLUGIN.md`), using `/context-harvest`, `/style-sync`, and `/memory-primer` to keep Claude's memory aligned with Vib3 Scribe profiles as release rituals evolve.
