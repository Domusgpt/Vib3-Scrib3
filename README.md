...
- **Claude Plugin Operations**: `/plugin-ops` now highlights signup momentum, status queues (new/contacted vs. activated/closed), multi-touch accounts, and individual touches so launch owners can confirm onboarding demand before publishing the plugin.
