...
- **Claude Plugin Operations**: `/plugin-ops` highlights signup momentum, multi-touch accounts, and individual touches so launch owners can confirm onboarding demand before publishing the plugin.
