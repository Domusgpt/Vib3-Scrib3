...
- **Detail sheets** let you assign an owner, log follow-up notes, mark the current status, and set a next action timestamp so every signup has a clear hand-off before you issue Vib3 sessions.
