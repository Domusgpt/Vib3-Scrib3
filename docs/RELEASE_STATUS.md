...
- A rush Claude Code plugin is documented and live, enabling Anthropic-backed conversations through a manifest + OpenAPI surface secured by organization API keys.【F:README.md†L150-L170】【F:docs/CLAUDE_CODE_PLUGIN.md†L1-L73】
